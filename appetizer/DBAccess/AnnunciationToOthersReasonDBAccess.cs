...
namespace Taxer.DBA
{
public class AnnunciationToOthersReasonDBAccess
{
	...
	public List<Annunciation> GetListAnnunciation(int annunciationToOthersReasonID)
	{
		...
		SqlParameter[] parametersAnnunciationToOthersReason = new SqlParameter[]
		{
			new SqlParameter("@AnnunciationToOthersReasonID", annunciationToOthersReasonID)
		};

		//Lets get the list of Annunciation records from database
		using (DataTable table = SqlDBHelper.ExecuteParamerizedSelectCommand("Annunciation_GetList_UseInAnnunciationToOthersReason", CommandType.StoredProcedure, parametersAnnunciationToOthersReason))
		{
	...
	public Int64 Insert(AnnunciationToOthersReason annunciationToOthersReason)
	{
		SqlParameter[] parametersAnnunciationToOthersReason = new SqlParameter[]
		{
			new SqlParameter("@Title", annunciationToOthersReason.Title)
		};
		annunciationToOthersReason.AnnunciationToOthersReasonID = Convert.ToInt32(SqlDBHelper.ExecuteScalar("AnnunciationToOthersReason_Insert", CommandType.StoredProcedure, parametersAnnunciationToOthersReason));
		return annunciationToOthersReason.AnnunciationToOthersReasonID;
	}
	...
	public bool Update(AnnunciationToOthersReason annunciationToOthersReason)
	{
		SqlParameter[] parametersAnnunciationToOthersReason = new SqlParameter[]
		{
			new SqlParameter("@AnnunciationToOthersReasonID", annunciationToOthersReason.AnnunciationToOthersReasonID),
			new SqlParameter("@Title", annunciationToOthersReason.Title)
		};
		return SqlDBHelper.ExecuteNonQuery("AnnunciationToOthersReason_Update", CommandType.StoredProcedure, parametersAnnunciationToOthersReason);
	}
	...
	public bool Delete(int annunciationToOthersReasonID)
	{
		...
		return SqlDBHelper.ExecuteNonQuery("AnnunciationToOthersReason_Delete", CommandType.StoredProcedure, parametersAnnunciationToOthersReason);
	}

	public AnnunciationToOthersReason GetDetails(int annunciationToOthersReasonID)
	{
		AnnunciationToOthersReason annunciationToOthersReason = new AnnunciationToOthersReason();

		SqlParameter[] parametersAnnunciationToOthersReason = new SqlParameter[]
		{
			new SqlParameter("@AnnunciationToOthersReasonID", annunciationToOthersReasonID)
		};
		using (DataTable table = SqlDBHelper.ExecuteParamerizedSelectCommand("AnnunciationToOthersReason_GetDetails", CommandType.StoredProcedure, parametersAnnunciationToOthersReason))
		{
			if (table.Rows.Count == 1)
			{
				DataRow row = table.Rows[0];

				annunciationToOthersReason.AnnunciationToOthersReasonID = (row["AnnunciationToOthersReasonID"] != DBNull.Value) ? Convert.ToInt32(row["AnnunciationToOthersReasonID"]) : 0 ;
				annunciationToOthersReason.Title = row["Title"].ToString();
			}
		}

		return annunciationToOthersReason;
	}

	public List<AnnunciationToOthersReason> GetListAll()
	{
		List<AnnunciationToOthersReason> listAnnunciationToOthersReason = null;

		using (DataTable table = SqlDBHelper.ExecuteSelectCommand("AnnunciationToOthersReason_GetListAll", CommandType.StoredProcedure))
		{
			if (table.Rows.Count > 0)
			{
				listAnnunciationToOthersReason = new List<AnnunciationToOthersReason>();
				...
				foreach (DataRow row in table.Rows)
				{
					...
					annunciationToOthersReason.AnnunciationToOthersReasonID = (row["AnnunciationToOthersReasonID"] != DBNull.Value) ? Convert.ToInt32(row["AnnunciationToOthersReasonID"]) : 0 ;
					annunciationToOthersReason.Title = row["Title"].ToString();
					listAnnunciationToOthersReason.Add(annunciationToOthersReason);
				}
			}
		}

		return listAnnunciationToOthersReason;
	}
	...
	public bool Exists(int annunciationToOthersReasonID)
	{
		...
		return (SqlDBHelper.ExecuteScalar("AnnunciationToOthersReason_Exists", CommandType.StoredProcedure, parametersAnnunciationToOthersReason)>0);
	}
	...
	{
		List<AnnunciationToOthersReason> listAnnunciationToOthersReason = new List<AnnunciationToOthersReason>();
		...
		using (DataTable table = SqlDBHelper.ExecuteParamerizedSelectCommand("AnnunciationToOthersReason_SearchLike", CommandType.StoredProcedure, parametersAnnunciationToOthersReason))
		{
			if (table.Rows.Count > 0)
			{
				foreach (DataRow row in table.Rows)
				{
					AnnunciationToOthersReason tmpAnnunciationToOthersReason = new AnnunciationToOthersReason();
					tmpAnnunciationToOthersReason.AnnunciationToOthersReasonID = (row["AnnunciationToOthersReasonID"] != DBNull.Value) ? Convert.ToInt32(row["AnnunciationToOthersReasonID"]) : 0 ;
					tmpAnnunciationToOthersReason.Title = row["Title"].ToString();

					listAnnunciationToOthersReason.Add(tmpAnnunciationToOthersReason);
				}
			}
		}
